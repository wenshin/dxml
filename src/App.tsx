...
function App() {
  return (
    <div style={{ padding: 40 }}>
      <section>
      <d-text crop="2px"><h1>布局的原理</h1></d-text>
      ...
      <section>
      <d-text crop="2px"><h1>圣杯布局</h1></d-text>
...
`<d-view layout='col' gap='10px'>
  ...
  <d-row align-items='center'>
    Footer
      ...
      <section>
        <d-text crop="2px"><h1>等宽 3 列，元素水平垂直居中</h1></d-text>
        <div className='case-container'>
...
`<d-view layout='row' gap='12px'>
  ...
  <d-col dimension='1' align-items='center'>CC</d-col>
      ...
      <section>
        <d-text crop="2px"><h1>不同比例列，元素水平垂直居中</h1></d-text>
        <div className='case-container'>
          <d-view layout='row' gap='12px'>
...
`<d-view layout='row' gap='12px'>
  ...
  <d-col dimension='2' align-items='center'>CC</d-col>
      ...
      <section>
        <d-text crop="2px"><h1>水平三明治布局</h1></d-text>
        <div className='case-container'>
          <d-view layout='row' gap='12px'>
...
`<d-view layout='row' gap='12px'>
  ...
  <d-col align-items='center'>C</d-col>
      ...
      <section>
        <d-text crop="2px"><h1>垂直三明治布局</h1></d-text>
        <div className='case-container'>
...
`<d-view layout='col' gap='12px'>
  ...
  <d-row align-items='center'>C</d-row>
      ...
      <section>
        <d-text crop="2px"><h1>不同比例行布局</h1></d-text>
        <div className='case-container'>
          <d-view layout='col' gap='12px'>
...
`<d-view layout='col' gap='12px'>
  ...
  <d-row dimension='2' gap='10px' style={{backgroundColor: 'transparent'}}>
    ...
    <d-col align-items='center'>C</d-col>
      ...
      <section>
        <d-text crop="2px"><h1>浮动元素定位</h1></d-text>
        <div className='case-container'>
          <d-view>
...
`<d-view>
  ...
  <d-float align='center'>center</d-float>
      ...
      <section>
        <d-text crop="2px"><h1>inline 元素布局</h1></d-text>
        <div className='case-container'>
...
`<d-view layout="inline" gap='12px 16px'>
  ...
  <d-elem class='inline-elem3' layout='row' gap='10px'>
    ...
    <d-col align-items='center'>C</d-col>
      ...
      <section>
        <d-text crop="2px"><h1>自动修正文本 line height 导致的边距问题</h1></d-text>
        <d-row gap="12px">
