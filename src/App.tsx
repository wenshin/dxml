    ...
    <div style={{ padding: 20 }}>
      ...
      <section>
        ...
        <p>
          ...
          这项技术也有缺点，
          首先，技术成本很高，从 2017 年开始，2019 年 1 月发布体验版，目前保持每月迭代，整个网站易用性还是比较差，loading 时间长，阻塞问题比较多，明显维护投入不是很充足。
          其次，设计和研发规范迭代维护成本如何，以及如何保持和适配 DSL 兼容并保证可靠性，都还没有得到很好验证。
          因此如果有一套设计和技术都遵循的 DSL，相信 imgcook 的成本和不确定性将大大降低。
        </p>
        <p>
          在深入学习 flex 的过程中，我发现它是一个功能强大，底层抽象极致的布局体系。
          但是缺点也很明显，首先概念复杂，理解和熟练应用成本很高；其次和常见的 UI 设计工具概念差异很大。
